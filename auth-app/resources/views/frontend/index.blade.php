                    ...
                    <div class="latest-product">
                        ...
                        <div class="product-carousel">
                                ...
                                @foreach($products as $product)
                                    ...
                                    <div class="single-product">
                                        <div class="product-f-image">
                                            <img src="{{ asset('uploads/product/' . $product->product_image ) }}" alt="" width="420px" height="250px">
                                            <div class="product-hover">
                                                <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                                <a href="{{ Route('singleP', $product->id ) }}" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                            </div>
                                        </div>
                                        
                                        <h2><a href="{{ Route('singleP', $product->id ) }}">{{ $product->product_name }}</a></h2>
                                        
                                        <div class="product-carousel-price">
                                            <ins>&#2547;{{ $product->current_price }} </ins> <del>&#2547;{{ $product->previous_price }}</del>
                                        </div> 
                                    </div>
                            ...
                            @else
                                ...
                                {{ 'No Product Availabe in the Stock' }}
